...
int main() {
 ...
 //initialization 
    ...
    FILE* cloud_key = fopen("/mnt/c/Users/BeastUnleashed/Documents/PhD/workspace/Database/FHE_addition/cloud storage/cloud.key","wb");
...
//export the input to cloud
   FILE* query_data=fopen("/mnt/c/Users/BeastUnleashed/Documents/PhD/workspace/Database/FHE_addition/cloud storage/query.data","wb");
